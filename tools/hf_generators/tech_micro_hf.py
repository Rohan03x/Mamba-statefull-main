"""HF block generator for technical + microstructure ensemble signals."""
...
def build(
    ...
    """Materialize tech_micro_hf score/conf pairs using cached base families."""
    LOGGER.info(
