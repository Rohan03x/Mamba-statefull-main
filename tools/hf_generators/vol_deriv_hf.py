"""HF block generator for volatility and derivatives signals."""
...
def build(
    ...
    """Materialize vol_deriv_hf block outputs from cached vol/derivatives families."""
    LOGGER.info(
