"""HF block generator for macro/regime state classification."""
...
def build(
    ...
    """Materialize macro_regime_hf block outputs using cached macro families."""
    LOGGER.info(
