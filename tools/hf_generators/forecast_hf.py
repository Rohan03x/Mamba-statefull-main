"""HF block generator for ensemble forecast families."""
...
def build(
    ...
    """Materialize forecast_hf block outputs from cached quantile/calibration families."""
    LOGGER.info(
